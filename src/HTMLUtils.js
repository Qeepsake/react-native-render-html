...
export const TextOnlyPropTypes = TextStylePropTypes.filter((prop) => ViewStylePropTypes1.indexOf(prop) === -1);
...
export const stylePropTypes = {
    [STYLESETS.VIEW]: ViewStylePropTypes1,
